...
require vs require-dev é um ponto de estudo de Composer que deve ser entendido pelo comportamento observado no runtime, pelo impacto no design e pela forma idiomática de uso em PHP 8.3/8.4.
...
// runtime: ramsey/uuid; dev: phpstan/phpstan e phpunit/phpunit
```
...
[[composer.json]] [[Autoload PSR-4]] [[O que é Composer]] [[composer.json]] [[Autoload PSR-4]] [[Versionamento semântico]] [[01-Roadmap]]
