...
Value Objects é um ponto de estudo de Arquitetura que deve ser entendido pelo comportamento observado no runtime, pelo impacto no design e pela forma idiomática de uso em PHP 8.3/8.4.
...
final readonly class Email { public function __construct(public string $value) {} }
```
...
[[Use Cases]] [[Aggregates]] [[Use Cases]] [[Domain Events]] [[Repository]] [[01-Roadmap]]
