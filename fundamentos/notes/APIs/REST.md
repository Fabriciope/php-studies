...
REST é um ponto de estudo de APIs que deve ser entendido pelo comportamento observado no runtime, pelo impacto no design e pela forma idiomática de uso em PHP 8.3/8.4.
...
// GET /orders?cursor=abc retorna uma coleção paginada de pedidos.
```
...
[[OpenAPI]] [[PSR-7]] [[PSR-7]] [[PSR-15]] [[OpenAPI]] [[01-Roadmap]]
